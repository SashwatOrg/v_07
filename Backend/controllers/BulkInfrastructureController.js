...
const generateInfrastructureTemplate = (filePath) => {
  try {
    const headers = [
      {
        dept: "Department",
        infraDesc: "Infrastructure Description",
        infraBudget: "Budget",
    ...
    xlsx.utils.book_append_sheet(workbook, worksheet, "Infrastructure Template");
    xlsx.writeFile(workbook, filePath);
    console.log(`Template generated at: ${filePath}`); // Log the file path
  } catch (error) {
